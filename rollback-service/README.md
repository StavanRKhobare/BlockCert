...
- [D2.5] Checkpoint orchestration function (hash + full snapshot + hash chain + optional anchoring) — files: rollback-service/checkpoint_store/hasher.py, rollback-service/tests/test_checkpoint_round.py.
